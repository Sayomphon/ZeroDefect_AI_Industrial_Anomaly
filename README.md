...
เปิด [`notebooks/00_colab_quickstart.ipynb`](notebooks/00_colab_quickstart.ipynb)
ผ่านปุ่ม **Open In Colab** แล้วเลือก **Runtime → Run all** ได้ทันที Notebook จะ clone
branch `main`, ติดตั้ง `.[demo]`, รัน synthetic smoke workflow และแสดง prediction overlay
โดยไม่ต้องใช้ GPU

Gradio public share ถูกปิดไว้ใน notebook โดย default หากต้องการเปิด UI ต้อง opt in ใน cell สุดท้าย
และกำหนด username/password ชั่วคราว ห้ามใช้ภาพโรงงานจริงหรือข้อมูลลับกับ public share URL
รายละเอียดการตรวจและข้อจำกัดอยู่ที่
[`docs/COLAB_READINESS.md`](docs/COLAB_READINESS.md)
...
- ไม่ hard-code secret และไม่เปิด Gradio public share โดย default
- Colab Gradio helper ต้องยืนยัน public exposure และใช้ authentication ก่อนสร้าง share URL
